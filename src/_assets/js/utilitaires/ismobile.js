...
var website = (function (publics) {
    ...
    "use strict";
    //var privates = {};
    publics.body = document.getElementsByTagName("body")[0];


    publics.isMobile = false; //initiate as false
    publics.isTablet = false; //initiate as false
    publics.isDesktop = false; //initiate as false
